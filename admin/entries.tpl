...
<!-- insUrl Modal -->
<div class="modal fade" id="insUrlModal" tabindex="-1" role="dialog" aria-labelledby="insUrlModal">
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        <label for="urlText" class="control-label">URL:</label>
                        <input class="form-control" id="urlText" />
                        <label for="descriptionText" class="control-label">Description:</label>
                        <input class="form-control" id="descriptionText" />
                        <label for="titleText" class="control-label">Title/Tooltip:</label>
                        <input class="form-control" id="titleText"/>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="targetBlank" id="targetBlank">
                            Open links in a new window? (ie. target="_blank")
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="relNoFollow" id="relNoFollow">
                            Prevent crawlers from following? (ie. rel="nofollow")
                        </label>
                    </div>
                    <input class="hidden" id="textAreaId" />
                </form>
            </div>
...
<form id="serendipityEntry" name="serendipityEntry" {$entry_vars.entry.entry_form} action="{$entry_vars.targetURL}" method="post">
    ...
    {if NOT $entry_vars.wysiwyg}
        ...
        {/if}
            ...
            <button class="pop_insurlModal" type="button" data-toggle="modal" data-tarea="serendipity[body]">URL</button>
